								...
								<tbody>
									...
									<tr style="background-color: <?php if($key % 2 == 0){echo '#f1f1f1';}else{echo '#ffffff';}?>">
										...
										if($value->contenttype=='html'){
											...
											?>icon-banner.png<?php } 
										?>">&nbsp;&nbsp;<a href="<?php echo base_url();?>users/banner?bannerid=<?php echo $value->bannerid;?>&campaignid=<?php echo $value->campaignid;?>&clientid=<?php echo $value->clientid;?>"><?php echo $value->description;?></td>
										<td width="10%"><ul class="rowActions" style="list-style-type:none;">
                                              <li><a  href="banner-acl.php?clientid=4&amp;campaignid=4&amp;bannerid=3">Delivery</a></li>
                                              <li style="padding-top: 10px;"><a  href="banner-activate.php?clientid=4&amp;campaignid=4&amp;bannerid=3&amp;value=0">Deactivate</a></li>
                                            </ul>
										</td>
										<td width="25%">
