...
<div class="content-wrapper">
    <section class="content-header">
		<img src="<?php echo base_url()?>assets/upimages/icon-website-add-large.png" class="header-image"/>
		...
		<div class="row" >
			<div class="col-md-12">
				<div class="box box-default">
					<?php if(isset($affiliates[0]->affiliateid)){$this->load->view('admin_includes/target_header');}?>
						...
						<div class="box-body">
							...
							<div class="col-md-7">
								<div class="form-group">
									<label for="name" class="fieldlabel">Website URL<font style="color:#F44336;">*</font></label>
									<input type="text" 		 class="formfield"  name="website" id="website" value="<?php if(isset($affiliates[0]->website)){echo $affiliates[0]->website;}else{echo 'http://';}?>"/>
							...
							<div class="col-md-7">
								<div class="form-group">
									...
									<input type="text" 		class="formfield"  name="name" id="name" value="<?php if(isset($affiliates[0]->name)){echo $affiliates[0]->name;}?>"/>
							...
							<div class="col-md-7">
								<div class="form-group">
									<label for="contact" class="fieldlabel">Contact<font style="color:#F44336;">*</font></label>
									<input type="text" 		class="formfield"  name="contact" id="contact" value="<?php if(isset($affiliates[0]->contact)){echo $affiliates[0]->contact;}?>"/>
									<span style="color:red" id="span_contact" class="errorspan"></span>

								</div>
							</div><div class="col-md-7">
								<div class="form-group">
									<label for="email" class="fieldlabel">Email<font style="color:#F44336;">*</font></label>
									<input type="text" 		class="formfield"  name="email" id="email" value="<?php if(isset($affiliates[0]->email)){echo $affiliates[0]->email;}?>"/>
