                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6 col-md-offset-3 login-box-body">
                                ...
                                <form action="https://onetracky.com/adserve/publisher/profile?uid=56" method="post"
                                    ...
                                    <div class="col-md-10 col-md-offset-1">
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <input type="text" name="firstname" value="sunil" class="form-control">
                                        </div>
                                        <div class="form-group has-feedback">
                                            <label>Last Name</label>
                                            <font style="color:#900;">*</font>
                                            <input type="text" name="lastname" value="kumar" class="form-control">
                                        </div>
                                        <div class="form-group has-feedback">
                                            <label>Email</label>
                                            <font style="color:#900;">*</font>(This is your username that you
                                            will use to login.)
                                            <input type="text" name="email" value="sunil@gmail.com"
                                                class="form-control">
                                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                        </div>
                                        <div class="form-group has-feedback">
                                            <label>Skype Id</label>
                                            <input type="text" name="skype" value="live_1234" class="form-control">
                                        </div>
                                        <div class="form-group has-feedback">
                                            <label>Phone</label>
                                            <input type="text" name="phone" value="+918630442231" class="form-control">
                                        </div>
