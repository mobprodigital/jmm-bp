...
<div class="content-wrapper">
    <section class="content-header">
			<img src="<?php echo base_url()?>assets/upimages/icon-targeting-channel-large.png" class="header-image"/>
		<h3 class="header"><span style="color:#333333;">Add new Targeting Channel</span></h3>
						...
						<div class="box-body">
							...
							<div class="col-md-7">
								<div class="form-group">
									...
									<textarea name="comment" id="comment" class="formfield" style="width: 413px; height: 92px;"></textarea>
