            ...
            <div class="col-md-12">
              ...
              <div class="box box-default">
               ...
               <?php //echo validation_errors('<p class="form_error">','</p>'); ?>
				 <form  ng-submit="submitForm()" ng-controller="edituserController" method="post" name="groupForm">
                 <input type="hidden" ng-model="id" value="" />
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="username" ng-model="username" required  value="" ng-blur="uniqueUser()"  placeholder="Enter Username">
