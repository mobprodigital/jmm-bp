						...
						<?php }?>
							...
							<div class="col-md-7">
								<div class="form-group">
									<select tabindex="1" accesskey="l" onchange="disableTextarea();this.form.submit()" name="codetype">
									<option selected="" value="invocationTags:oxInvocationTags:async">Asynchronous JS Tag</option>
							...
							<div class="col-md-7">
								<div class="form-group">
									...
									<textarea name="comment" id="comment" class="formfield" style="width: 963px; height: 250px; margin: 0px 0px 0px 7px;"><?php if(isset($invocationCode)){echo $invocationCode;}?></textarea>
								</div>
							</div>
							<div class="col-md-7">
							...
							<div class="col-md-7">
								<div class="form-group">
									...
									<input type="radio" value="2" name="delivery"   style="margin-left: 195px;" id="delivery-t">&nbsp;&nbsp;<label for="delivery-t">&nbsp;No</label><br>
								</div>
