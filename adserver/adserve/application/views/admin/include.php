						...
						<?php }?>
							...
							<div class="col-md-7">
								<div class="form-group">
									...
									<input type="text" 		class="formfield"  name="zonename" id="zonename" placeholder="cricmagic.com - Default"/>
								</div>
							</div>
							<div class="col-md-7">
								<div class="form-group">
							...
							<div class="col-md-7">
								<div class="form-group">
									...
									<input type="radio" value="0" name="delivery" class="zone"   		  id="delivery-b"  checked="checked" style="margin-left:36px;">&nbsp;&nbsp; <label for="delivery-b"><img align="absmiddle" src="http://localhost/reviveadserver/www/admin/assets/images/icon-zone.gif">&nbsp;Banner, Button or Rectangle</label><br>
							...
							<div class="col-md-7">
								<div class="form-group">
									<label for="name" class="fieldlabel">Size</label>
										<td width="100%">
											<input    type="radio"  	value="default" name="sizetype" id="size-d" style="margin-left:33px;">
										...
										<br>
										<input   type="radio" value="custom" name="sizetype" id="size-c" style="margin-left:262px;">&nbsp;&nbsp;&nbsp;Width: &nbsp;&nbsp;&nbsp;
