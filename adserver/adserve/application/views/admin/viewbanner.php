            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <a href="#" id="delete-banner"><img class="delete-text"
                                src="<?php echo base_url()?>assets/img/1011.png" />Delete</a>
                    </div>
                    <div class="box-body">
						...
						?>
                        <form action="<?php echo base_url()?>users/viewbanner" method="post" name="filter_form"
                            id="filter_form" autocomplete="off">
                            <div class="row ">
                                <div class="col-md-2 form-group">
                                    <select class="view-banner-filter" name="sort_type" id="banner_sort_type"
                                ...
                                <div class="col-md-2 form-group">
                                    <select class="view-banner-filter" name="banner_status" id="banner_status"
                            ...
                            <table id="example" class="table table-striped">
                                <thead>
                                    <tr class="header-row" class="center-align">
                                        <th width="2%"><input type="checkbox" class="banner" id="main_0" value="adchk">
                                        </th>
                                        <th width="30%">Name</th>
                                        <th width="30%">Date</th>
                                ...
                                <tbody>
                                    ...
                                    <tr
                                        ...
                                        <td width="2%"><input type="checkbox" class="banner"
                                                id="<?php echo $value->bannerid;?>"></td>
                                        <td width="30%"><img src="<?php echo base_url();?>/assets/upimages/
										<?php 
										...
										?>">&nbsp;&nbsp;
                                            <a
                                                href="<?php echo base_url();?>users/banner?bannerid=<?php echo $value->bannerid;?>&campaignid=<?php echo $value->campaignid;?>&clientid=<?php echo $value->clientid;?>">
                                                <?php echo $value->description;?>
                                            </a>
                                        </td>
                                        <td width="30%"><?php echo $value->updated; ?> </td>
                                        <td width="10%">
                                            <ul class="rowActions" style="list-style-type:none;">
                                                <li style="width: 118px;">
                                                    <a
                                                        href="<?php echo base_url();?>users/banner_acl?bannerid=<?php echo $value->bannerid;?>&campaignid=<?php echo $value->campaignid;?>&clientid=<?php echo $value->clientid;?>">
                                                        Delivery Option</a>
                                                </li>

                                                <li style="margin-top: 19px;">
                                                    <select name="bannerstatus "
                                                        id="banner_<?php echo $value->bannerid;?>"
                                                        class="bannerstatus view-banner-filter">
                                                        <option value="1"
