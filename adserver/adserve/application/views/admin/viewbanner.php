								...
								<tbody>
									...
									<tr style="background-color: <?php if($key % 2 == 0){echo '#f1f1f1';}else{echo '#ffffff';}?>">
										...
										<td width="10%"><ul class="rowActions" style="list-style-type:none;">
                                              <li><a  href="<?php echo base_url();?>users/banner_acl?bannerid=<?php echo $value->bannerid;?>&campaignid=<?php echo $value->campaignid;?>&clientid=<?php echo $value->clientid;?>">Delivery Option</a></li>
