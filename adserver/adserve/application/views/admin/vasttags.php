					...
					<form method="post" 	name = "addbanner" 		id = "addbanner">
						...
						<?php }?>
							...
							<div class="col-md-7">
								<div class="form-group">
									<select  name="codetype">
										<option value="">Javascript Tag</option>
										<option selected=""  value="async">Asynchronous JS Tag</option>
							...
							<div class="col-md-7">
								...
								<div>
									<textarea id='bannercode' name='bannercode' class='code-gray' rows='15' cols='80' style='width:95%; border: 1px solid black' readonly class="formfield"><?php if(isset($tags)){echo $tags;}?></textarea>
								</div>
							...
							<div class="col-md-7">
								<div class="form-group">
									...
									<input type="radio" value="2" name="delivery"   style="margin-left: 194px;" id="delivery-t">&nbsp;&nbsp;<label for="delivery-t">&nbsp;No</label><br>
								</div>
							...
							<div class="col-md-7">
								<div class="form-group">
									...
									<select tabindex="8" name="thirdpartytrack"    style="margin-left: 38px;">
										...
										<option value="3rdPartyServers:ox3rdPartyServers:doubleclick">Doubleclick/DFP</option>
										<option value="3rdPartyServers:ox3rdPartyServers:openadstream">Open AdStream</option>
										<option value="3rdPartyServers:ox3rdPartyServers:max">Revive Adserver</option>
									</select>								
								</div>
							</div>
							<div class="col-md-7">
						...
						<div class="box-footer">
							<input class="btn btn-primary"  name="submit" id="submit" type="submit" value="Refreash"/>
			</div>
		</div>
	</section>
</div>
