<?php
$Admin_description = 'Chess School Admin';
$title_for_admin = 'Chess School'
?>
<!DOCTYPE html>
<!--
			...
			<header class="main-header">
							...
							<li class="dropdown user user-menu">
								...
								<ul class="dropdown-menu">
									...
									<li class="user-footer">
										<div class="pull-left">
											<a href="<?php echo site_url($this->session->userdata('username').'/settings/'.$this->session->userdata('uid')) ?>" class="btn btn-default btn-flat">Profile</a>
										</div>
				...
				<div class="ad-menu">
					<ul class="menu1">
						...
						<li><a href="<?php  echo base_url().'users/statistics/adcampstats';?>"  	style="<?php if(isset($cat)){ if($cat	== 'statistics'){echo 'background:#428bca;'; } } ?>" class="top-menu"  id="stats">Statistics</a></li>
						<li><a href="<?php  echo base_url().'users/create';?>"  					style="<?php if(isset($cat)){ if($cat	== 'inventory'){echo 'background:#428bca;'; } } ?>" class="top-menu"  id="inventory">Inventory</a></li>
