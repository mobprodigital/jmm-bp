     ...
     <!-- InputMask -->
     <script src="<?php echo base_url();?>assets/plugins/input-mask/jquery.inputmask.js" type="text/javascript">
     </script>
     ...
     <script src="<?php echo base_url();?>assets/plugins/colorpicker/bootstrap-colorpicker.min.js"
         type="text/javascript"></script>
     <script src="<?php echo base_url();?>assets/plugins/slimScroll/jquery.slimscroll.min.js" type="text/javascript">
     </script>
...
$(function() {
    ...
    $(".timepicker").timepicker({
     ...
     <!--Common Js-->
     <script src="<?php echo base_url();?>assets/js/adserver.js" type="text/javascript"></script>
