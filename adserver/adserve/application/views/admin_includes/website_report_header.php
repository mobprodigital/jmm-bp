...
if( $activeaction == 'webzonestats'){ 
	...
	<ul class="menu1">
		<li>
			<a href="<?php  echo base_url().'users/webzonestats?'.$queryString;?>" style="<?php if(isset($cat)){ if($cat	== 'statistics' && $activeaction == 'webzonestats' && ($breakthrough == 'affiliate' || $breakthrough == '')){echo 'background:#428bca;'; } } ?>" class="top-menu" id="home">Website Statistics</a>
		</li>
		<li>
			<a href="<?php echo base_url().'users/webzonestats?breakthrough=zone'.$queryString;?>"  style="<?php if(isset($cat)){ if($cat	== 'statistics' && $activeaction == 'webzonestats' && $breakthrough == 'zone'){echo 'background:#428bca;'; } } ?>" class="top-menu" id="stats">Zone </a>
		</li>
		<li>
			<a href="<?php echo base_url().'users/webzonestats?breakthrough=campaigns'.$queryString.$zoneString;?>"  style="<?php if(isset($cat)){ if($cat	== 'statistics' && $activeaction == 'webzonestats' && $breakthrough == 'campaigns'){echo 'background:#428bca;'; } } ?>" class="top-menu" id="stats">Campaign Distribution</a>
		</li>
		...
		?>
		<li>
			<a href="<?php echo base_url().'users/webzonevideostats'.$videoReportUrl;?>"  style="<?php if(isset($cat)){ if($cat	== 'statistics' && $activeaction == 'webzonestats' && $breakthrough == 'video'){echo 'background:#428bca;'; } } ?>" class="top-menu" id="stats"> <?php echo $checkVideoPub['expansionType'];?> Video Report</a>
		</li>
		<?php } ?>
