<aside class="main-sidebar" style="color:<?php if(isset($cat)){ if($cat	== 'inventory'){ echo '#ebebeb'; }else{echo '#fff';} }else{echo '#fff';} ?>">
	<section class="sidebar">
		...
		<ul class="sidebar-menu" id="inventory_sidebar" style="display:<?php if(isset($cat)){ if($cat	== 'inventory'){ echo 'block'; }else{echo 'none';} }else{
			...
			-->
			<li class="treeview <?php if(isset($activeaction)){if($activeaction=='notification') {echo 'active';}}?>"><a href="<?php echo base_url().'notification/get_all_notifications';?>"><i class="fa fa-bell" aria-hidden="true"></i><span>Notification</span><i class="fa fa-angle-left pull-right"></i></a>
				</li>
			<?php }if($this->session->userdata('role')=='admin'){ ?>
