...
if( $activeaction == 'website'){
	...
	<ul class="menu1">
		<li><a href="<?php  echo base_url().'users/website?affiliateid='.$_GET['affiliateid'];?>"   	style="<?php if(isset($cat)){ if($cat	== 'inventory' && $activeaction == 'website'){echo 'background:#428bca;'; } } ?>" class="top-menu"    		id="home">Website Properties</a></li>
