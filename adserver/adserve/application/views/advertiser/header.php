	...
	<body class="skin-blue sidebar-mini">
		<div class="wrapper">
			<header class="main-header">
							...
							<li class="dropdown user user-menu">
								...
								<ul class="dropdown-menu">
									...
									<li class="user-footer">
										<div class="pull-left">
											<a href="<?php echo base_url().'advertiser/profile?uid='.$this->session->userdata('uid');?>" class="btn btn-default btn-flat">Profile</a>
										</div>
										<div class="pull-right">
											<a href="<?php echo site_url('advertiser/logout') ?>" class="btn btn-default btn-flat">Sign out</a>
										</div>
									</li>
								</ul>
							</li>
				...
				<div class="ad-menu">
					<ul class="menu1">
						<li><a href="<?php  echo base_url().'advertiser';?>" style="<?php if(isset($cat)){ if($cat	== 'home'){echo 'background:#428bca;'; } } ?>" class="top-menu"  id="home">Home</a></li>
						<li><a href="<?php  echo base_url().'advertiser/delivery';?>"  style="<?php if(isset($cat)){ if($cat	== 'inventory'){echo 'background:#428bca;'; } } ?>" class="top-menu"  id="delivery">Delivery</a></li>
						<li><a href="<?php  echo base_url().'advertiser/adcampstats';?>" style="<?php if(isset($cat)){ if($cat	== 'statistics'){echo 'background:#428bca;'; } } ?>" class="top-menu"  id="stats">Statistics</a></li>
