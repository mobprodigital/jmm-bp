                        ...
                        <div class="box-body">
                            ...
                            <div class="">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="formfield" name="campaign" id="campaign"
                                        value="<?php if(isset($campaign[0]->campaignid)){echo $campaign[0]->campaignname;}?><?php if(isset($defaultCampaign)){echo $defaultCampaign;?> - Default Campaign<?php } ?>" /></br>
                                    <label for="name" class="fieldlabel"></label <span
                                        style="color:red;margin-left:40px;" id="span_campaign"></span>
                                </div>
                            </div>
                            <!--<div class="">
								<div class="form-group">
                            ...
                            <div class="">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="radio-button-label">
                                        <input id="startSet_immediate" name="startSet" value="f"
                            ...
                            <div class="">
                                <div class="form-group">
                                    ...
                                    <label class="radio-button-label"> <input id="endSet_immediate" name="endSet"
                                            value="f"
                                            <?php if(isset($campaign[0]->campaignid)){if($campaign[0]->expirationtion_calc !='yes'){echo 'checked="checked"';}}else{echo 'checked="checked"';} ?>
                                            type="radio"> Don't expire </label>

                                    <label class="radio-button-label"><input id="endSet_specific" name="endSet"
                                            value="t"
                                            <?php if(isset($campaign[0]->campaignid)){if($campaign[0]->expirationtion_calc =='yes'){echo 'checked="checked"';}} ?>
                                            type="radio">Set specific date</label>
                                    <span id="specificEndDateSpan"
                                        ...
                                        <div style="width: 22%;margin-left:223px;" class='input-group date'
                                            ...
                                            <input type='text' class="form-control" name="expire_time" id="expire_time"
                                                ...
                                                value="<?php if(isset($campaign[0]->campaignid)){echo $campaign[0]->expire_time;}?>" />
                                            <span class="input-group-addon">
                                                <span class="glyphicon glyphicon-calendar"></span>
                                            </span>
                                        </div>
...
<div class="errormessage" style="margin-top: 2em"><img class="errormessage"
    ...
    There are currently no campaigns defined, because there are no advertisers. To create a campaign, <a
