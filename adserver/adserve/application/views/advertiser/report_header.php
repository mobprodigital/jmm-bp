...
if( $activeaction == 'adcampstats'){ 
	...
	<?php if((!$bannerReport) && (!$affiliateReport)){ ?>
		<li>
			<a href="<?php  echo base_url().'advertiser/adcampstats?breakthrough=client'.$queryString;?>" style="<?php if(isset($cat)){ if($cat	== 'statistics' && $activeaction == 'adcampstats' && ($breakthrough == 'client' || $breakthrough == '')){echo 'background:#428bca;'; } } ?>" class="top-menu" id="home">Advertiser Statistics</a>
		</li>
		<li>
			<a href="<?php echo base_url().'advertiser/adcampstats?breakthrough=campaign'.$queryString;?>"  style="<?php if(isset($cat)){ if($cat	== 'statistics' && $activeaction == 'adcampstats' && $breakthrough == 'campaign'){echo 'background:#428bca;'; } } ?>" class="top-menu" id="stats">Campaigns </a>
		</li>
	<?php } ?>	
		<!-- start banner  report -->
		...
		?>
		<li>
			<a href="<?php echo base_url().'advertiser/adcampstats'.$bannerReportUrl;?>"  style="<?php if(isset($cat)){ if($cat	== 'statistics' && $activeaction == 'adcampstats' && $breakthrough == 'banner'){echo 'background:#428bca;'; } } ?>" class="top-menu" id="stats">Banners</a>
		</li>
		<?php } ?>
		
		<!-- end banner  report -->
		<li>
			<a href="<?php echo base_url().'advertiser/adcampstats?breakthrough=affiliate'.$queryString.$affiliateQueryString;?>"  style="<?php if(isset($cat)){ if($cat	== 'statistics' && $activeaction == 'adcampstats' && $breakthrough == 'affiliate'){echo 'background:#428bca;'; } } ?>" class="top-menu" id="stats">Website Distribution</a>
		</li>
		...
		<li>
			<a href="<?php echo base_url().'advertiser/adcampvideostats'.$videoReportUrl;?>"  style="<?php if(isset($cat)){ if($cat	== 'statistics' && $activeaction == 'adcampstats' && $breakthrough == 'video'){echo 'background:#428bca;'; } } ?>" class="top-menu" id="stats"> <?php echo $checkVideoAdvt['expansionType'];?> Video Report</a>
