			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-body">
						...
						<?php $this->load->view('advertiser/report_header');?>
							<form action="<?php echo base_url()?>advertiser/adcampstats" name="period_form" id="period_form" autocomplete="off">
									...
									<td><img align="absmiddle" width="16" height="16" src="<?php echo base_url();?>assets/upimages/ltr/triangle-l.gif">
										...
										<?php if(isset($_GET['breakthrough']) && $_GET['breakthrough'] == 'affiliate'){ ?>
											<?php if (isset($_GET['affiliateid'])){ ?>	
												...
												<a href="<?php echo base_url().'advertiser/adcampstats?breakthrough=zone&affiliateid='.$_GET['affiliateid'].'&breakthrough=daily'.$affiliateQueryString;?>"><?php echo $value->day;?></a>
											<?php }else{ ?>
												<img align="absmiddle" width="16" height="16" src="<?php echo base_url();?>assets/upimages/icon-website.png"><a href="">
												<a href="<?php echo base_url().'advertiser/adcampstats?breakthrough=affiliate&affiliateid='.$value->publisherID."&clientid=".$_GET['clientid'].$affiliateQueryString;?>"><?php echo $value->publisherName;?></a>
											<?php } ?>
										...
										<?php }else if(isset($_GET['breakthrough']) && $_GET['breakthrough'] == 'banner'){  ?>
											<?php if (isset($_GET['bannerid'])){ ?>	
												...
												<a href="<?php echo base_url().'advertiser/adcampstats?breakthrough=banner&clientid='.$_GET['clientid'].'&campaignid='.$value->campaignID;?>"><?php echo $value->day;?></a>
											<?php }else{ ?>
												...
												<img align="absmiddle" width="16" height="16" src="<?php echo base_url();?>assets/upimages/icon-banner-html.png">&nbsp;&nbsp;&nbsp;&nbsp;
												<?php } ?>
												<a href="<?php echo base_url().'advertiser/adcampstats?breakthrough=banner&clientid='.$_GET['clientid'].'&campaignid='.$value->campaignID.'&bannerid='.$value->bannerID;?>"><?php echo $value->bannerName;?></a>
											<?php } ?>
										...
										<?php }else if(isset($_GET['breakthrough']) && $_GET['breakthrough'] == 'campaign'){  ?>
											...
											<?php if (isset($_GET['campaignid'])){ ?>	
												<img align="absmiddle" width="16" height="16" src="<?php echo base_url();?>assets/upimages/icon-date.gif"><a href="">
												<a href="<?php echo base_url().'advertiser/adcampstats?breakthrough=campaign&clientid='.$_GET['clientid'].'&campaignid='.$value->campaignid;?>"><?php echo $value->day;?></a>
											<?php }else{ ?>
												<img align="absmiddle" width="16" height="16" src="<?php echo base_url();?>assets/upimages/icon-campaign.gif"><a href="">
												<a href="<?php echo base_url().'advertiser/adcampstats?breakthrough=campaign&clientid='.$_GET['clientid'].'&campaignid='.$value->campaignid?>"><?php echo $value->campaignname;?></a>
										...
										<?php }else{ ?>
											<?php if(isset($_GET['clientid'])){ ?>
												...
												<a href="<?php echo base_url().'advertiser/adcampstats?breakthrough=day';?>"><?php echo $value->day;?></a>

											<?php }else{ ?>
												<img align="absmiddle" width="16" height="16" src="<?php echo base_url();?>assets/upimages/icon-advertiser.png"><a href="">

												<a href="<?php echo base_url().'advertiser/adcampstats?clientid='.$value->clientid;?>"><?php echo $value->clientname;?></a>
											<?php } ?>
										<?php } ?>
