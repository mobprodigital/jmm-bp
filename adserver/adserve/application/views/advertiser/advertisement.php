        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-default">
                    ...
                    <?php if(isset($advertiser[0]->clientname)){$this->load->view('advertiser/advertiser_header');}?>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <input class="formfield" type="text" name="name" id="name"
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="formfield" id="contact" name="contact"
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="formfield" id="email" name="email"
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="activeemail">Email when a campaign is automatically
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="formfield" id="report_interval" name="report_interval"
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <textarea name="comment" id="comment" class="formfield"
                                        style="width: 394px; height: 138px;"><?php if(isset($advertiser[0]->comments)){echo $advertiser[0]->comments;}?></textarea>
                                    <span style="color:red"></span>
                                </div>
                            </div>
                        </div>
