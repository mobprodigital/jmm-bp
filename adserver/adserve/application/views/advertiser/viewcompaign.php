            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <a href="#" id="delete-camp"><img src="<?php echo base_url()?>assets/img/1011.png"
                    ...
                    <div class="box-body">
                        <section class="text-right" style="display:none">
                            <label><input name="campaigns" id="campaigns" class="search form-control"
                                    style="width:295px;" placeholder="Search"
					...
					?>
                        <form action="<?php echo base_url()?>advertiser/viewcompaign" method="post" name="filter_form"
                                ...
                                <tbody>
                                    ...
                                    <tr
                                        ...
                                        <td><img
                                                ...
                                                href="<?php echo base_url();?>advertiser/compaign?clientid=<?php echo $value->clientid;?>&campaignid=<?php echo $value->campaignid;?>"><?php echo $value->campaignname;?></a>
                                        </td>
                                        ...
                                        <td class="center-align">
                                            <select name="camstatus" id="campaign_<?php echo $value->campaignid;?>"
                                                class="adv-camstatus view-banner-filter">
                                                <option value="1"
                                        ...
                                        <td class="center-align">
                                            <a
                                                href="<?php echo base_url();?>advertiser/banner?clientid=<?php echo $value->clientid;?>&campaignid=<?php echo $value->campaignid;?>">
                                                <div class="btn bg-blue btn-xs">Add new banner</div>
                                            </a>
                                            <a href="<?php echo base_url();?>advertiser/viewbanner?clientid=<?php echo $value->clientid;?>&campaignid=<?php echo $value->campaignid;?>"
                        ...
                        <div class="errormessage" style="margin-top: 2em"><img class="errormessage"
                                ...
                                align="absmiddle">No Campaings Exist</div>
                        <?php } ?>
                    </div>
                </div>
            </div>
