			...
			<div class="col-xs-12">
				<div class="box">
					...
					<div class="box-body">
						...
						<form action="<?php echo base_url()?>advertiser/index" name="period_form" id="period_form" autocomplete="off">
							...
							<div class="stats cf">
								<ul>
								<?php if(isset($advertiserStats) && ($advertiserStats->impressions)){ ?>
									<li class="impressions">
										<span><?php echo $advertiserStats->impressions;?></span>
										<em>impressions</em>
									</li>
									<li class="clicks">
										<span><?php echo $advertiserStats->clicks;?></span>
										<em>clicks</em>
									</li>
									<li class="ctr">
										<span><?php echo round(($advertiserStats->clicks / $advertiserStats->impressions*100),2) ;?>%</span>
