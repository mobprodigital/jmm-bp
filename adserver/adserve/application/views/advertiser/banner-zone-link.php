            ...
            <div class="col-md-12">
                <div class="box box-default">
                    ...
                    <div class="box-header with-border">
                        ...
                        <span>Banner : <?php echo $bannerDetails->description;?></span>
                    </div>
                    <div class="box-body">
                        ...
                        <div class="bannercode">
                            ...
                            <p>Banner Type : <?php if($bannerDetails->storagetype == 'html'){echo 'Video Ad Type';}?>
                            </p>
                            <p>Banner Size : <?php echo $bannerDetails->width;?> * <?php echo $bannerDetails->height;?>
                            </p>
                            <?php } ?>
                        ...
                        <table border="0" width="100%" cellpadding="0" cellspacing="0">
                            <form name="zones" action="<?php echo base_url();?>advertiser/linked_zone" method="post">
                                ...
                                <input type="hidden" name="bannerid"
                                    value="<?php if(isset($_GET['bannerid'])){echo $_GET['bannerid'];} ?>">
                                <input type="hidden" name="token" value="fb806ee9a733b29934c9d47f502ccede">
                                <tbody>
                                    <tr height="1">
                                        <td><img src="<?php echo base_url();?>assets/upimages/spacer.gif" width="300"
                                                height="1" border="0" alt="" title=""></td>
                                        <td><img src="<?php echo base_url();?>assets/upimages/spacer.gif" width="80"
                                                height="1" border="0" alt="" title=""></td>
                                        <td width="100%"><img src="<?php echo base_url();?>assets/upimages/spacer.gif"
                                                width="80" height="1" border="0" alt="" title=""></td>
                                    </tr>
                                    <tr height="25">
                                        <td><b><a href="#">Name</a><a href="#"><img
                                                        src="<?php echo base_url();?>assets/upimages/caret-u.gif"
                                                        border="0" alt="" title=""></a></b></td>
                                    ...
                                    <tr height="50" bgcolor="#F6F6F6">
										...
										-->
                                                        <td valign="top"><img
                                                                src="<?php echo base_url();?>assets/upimages/icon-affiliate.gif"
                                                                align="absmiddle">&nbsp;</td>
                                                        <td><a
                                    ...
                                    <tr height="50" bgcolor="#ddd">
										...
										?>
                                                        ...
                                                        <td valign="top"><input
                                                                name="includezone[<?php echo $value->zoneid;?>]"
                                                                <?php echo $checked;?>
                                                                id="a<?php echo $value->affiliateid;?>" type="checkbox"
                                                                value="t"
                                                                onclick="toggleAffiliate(<?php echo $value->affiliateid;?>);"
                                                                tabindex="2">&nbsp;&nbsp;</td>


                                                        <td valign="top"><img
                                                                src="<?php echo base_url();?>assets/upimages/icon-zone.gif"
                                                                align="absmiddle">&nbsp;</td>
                                                        <td><a
                                                                href="#"><?php echo $value->zonename;?></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                        ...
                        <div class="errormessage" style="margin-top: 2em"><img class="errormessage"
                                ...
                                align="absmiddle">No Sites with given with this ad unit exists</div>
