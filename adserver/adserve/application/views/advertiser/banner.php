<div class="content-wrapper">
    <section class="content-header">
		<img src="<?php echo base_url()?>assets/upimages/icon-banner-add-large.png" class="header-image"/>
		<h3 class="header"><span style="color:#333333;"><?php if(isset($banner[0]->bannerid)){ echo $banner[0]->description;}else{?>Add new banner<?php } ?></span></h3>
