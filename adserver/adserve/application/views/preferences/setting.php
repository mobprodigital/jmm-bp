			...
			<div class="col-xs-12">
				<div class="box">
					...
					<?php $role	= $this->session->userdata('role');if($role !='admin'){ ?>
						<form onsubmit="return max_formValidate(this);" action="" method="post" enctype="multipart/form-data" name="settingsform" id="settingsform">
						<table width="100%" cellspacing="0" cellpadding="0" border="0">
							<tbody>
								...
								<tr>
									...
									<td width="100%" valign="top" >&nbsp;<?php echo $users[0]->username;?></td>
									<td></td>
								</tr>
								<tr>
						...
						<input type="submit" class="btn btn-primary" tabindex="4" value="Save" name="submitsettings">
						</form>
							<?php } ?>
					</div>
				</div>
