			...
			<div class="col-xs-12">
				...
				<h3 class="box-header with-border">
					...
					<div class="box-body">
						...
						<?php $this->load->view('admin_includes/website_report_header');?>
							<form action="<?php echo base_url()?>users/webzonestats" name="period_form" id="period_form" autocomplete="off">
									...
									<td><img align="absmiddle" width="16" height="16" src="<?php echo base_url();?>assets/upimages/ltr/triangle-l.gif">
										...
										<?php if(isset($_GET['breakthrough']) && $_GET['breakthrough'] == 'zone'){ ?>
											<?php if (isset($_GET['zoneid'])){ ?>	
												...
												<a href="<?php echo base_url().'users/webzonestats?breakthrough=zone&affiliateid='.$_GET['affiliateid'].'&breakthrough=daily';?>"><?php echo $value->day;?></a>
											<?php }else{ ?>
												<img align="absmiddle" width="16" height="16" src="<?php echo base_url();?>assets/upimages/icon-zones.png"><a href="">
												<a href="<?php echo base_url().'users/webzonestats?breakthrough=zone&affiliateid='.$_GET['affiliateid'].'&zoneid='.$value->zoneID;?>"><?php echo $value->zoneName;?></a>
											<?php } ?>
										...
										<?php }else if(isset($_GET['breakthrough']) && $_GET['breakthrough'] == 'campaigns'){  ?>
											...
											<?php if (isset($_GET['campaignid'])){ ?>	
												...
												<a href="<?php echo base_url().'users/webzonestats?breakthrough=campaigns&affiliateid='.$_GET['affiliateid'].'&campaignid='.$value->campaignID;?>"><?php echo $value->day;?></a>
											<?php }else{ 
											...
											?>
												...
												<a href="<?php echo base_url().'users/webzonestats?breakthrough=campaigns&affiliateid='.$_GET['affiliateid'].'&campaignid='.$value->campaignID.$campaignZoneString;?>"><?php echo $value->campaignName;?></a>
										...
										<?php }else{ ?>
											<?php if(isset($_GET['affiliateid'])){ ?>
												...
												<a href="<?php echo base_url().'users/webzonestats?breakthrough=day';?>"><?php echo $value->day;?></a>

											<?php }else{ ?>
												<img align="absmiddle" width="16" height="16" src="<?php echo base_url();?>assets/upimages/icon-affiliate.gif"><a href="">

												<a href="<?php echo base_url().'users/webzonestats?affiliateid='.$value->affiliateid;?>"><?php echo $value->name;?></a>
											<?php } ?>
										<?php } ?>
