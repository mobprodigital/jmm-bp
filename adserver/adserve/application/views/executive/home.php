			...
			<div class="col-xs-12">
				<div class="box">
					...
					<div class="box-body">
						...
						<form action="<?php echo base_url()?>executive/index" name="period_form" id="period_form" autocomplete="off">
							...
							<div class="stats cf">
								...
								<?php if(isset($advertiserStats) && isset(($advertiserStats[0]->impressions))){ ?>
									...
									<li class="clicks">
										<span><?php echo $advertiserStats[0]->clicks;?></span>
										<em>clicks</em>
									</li>
									<li class="ctr">
										<span><?php echo round(($advertiserStats[0]->clicks / $advertiserStats[0]->impressions*100),2) ;?>%</span>
