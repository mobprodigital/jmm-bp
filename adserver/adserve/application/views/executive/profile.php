...
<div class="content-wrapper" style="min-height: 368px;">
	<section class="content">
		<div class="row">
			...
			<form action=""<?php echo base_url().'executive/profile?clientid='.$_GET['clientid'].'&uid='.$this->session->userdata('uid');?>" method="post" accept-charset="utf-8" class="form-signin">
				<div class="col-md-6">
