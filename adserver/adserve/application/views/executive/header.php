...
-->		
    ...
    <script src="<?php echo base_url();?>assets/plugins/jQuery/jQuery-2.1.4.min.js" type="text/javascript"></script>
		...
		<style>
		 .content-header .form-control{display:none;}
		 .content-header #submit{display:block;}
		 .content-header .btn-primary{display:none;}
		.ad-menu .menu1 li a {
			background:#093145;
		}
							...
							<li class="dropdown user user-menu">
								...
								<ul class="dropdown-menu">
									...
									<li class="user-footer">
										<div class="pull-left">
											<a href="<?php echo base_url().'executive/profile?clientid='.$_GET['clientid'].'&uid='.$this->session->userdata('uid');?>" class="btn btn-default btn-flat">Profile</a>
										</div>
										<div class="pull-right">
											<a href="<?php echo site_url('executive/logout') ?>" class="btn btn-default btn-flat">Sign out</a>
										</div>
									</li>
								</ul>
							</li>
				...
				<div class="ad-menu">
					<ul class="menu1">
						<?php if(isset($_GET['clientid'])){ 
						 ...
						 ?>
						<li><a href="<?php  echo base_url().'executive'.$clientString;?>" style="<?php if(isset($cat)){ if($cat	== 'home'){echo 'background:#428bca;'; } } ?>" class="top-menu"  id="home">Home</a></li>
						<li><a href="<?php  echo base_url().'advertiser/advertiser-campaigns'.$clientString;?>"  style="<?php if(isset($cat)){ if($cat	== 'inventory'){echo 'background:#428bca;'; } } ?>" class="top-menu"  id="delivery">Delivery</a></li>
						<li><a href="<?php  echo base_url().'executive/adcampstats'.$clientString;?>" style="<?php if(isset($cat)){ if($cat	== 'statistics'){echo 'background:#428bca;'; } } ?>" class="top-menu"  id="stats">Statistics</a></li>
