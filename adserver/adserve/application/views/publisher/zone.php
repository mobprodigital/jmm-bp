    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="box box-default">
                    <div class="box-header with-border">
                        <img src="<?php echo base_url()?>assets/upimages/icon-zone-add-large.png"
                            class="header-image" />
                    ...
                    <form method="post" name="zoneform" id="zoneform">
                        <div class="box-body">
                            <div class="errormessage" id="warning_change_zone_size" style="display: none;"> <img
                                    class="errormessage"
                                    src="http://localhost/revive/www/admin/assets/images/warning.gif" align="absmiddle">
                                <span class="tab-s"> Notice:</span><br>
                                Changing the zone size will unlink any banners that are not the new size, and will add
                                any banners from linked campaigns which are the new size
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <td width="100%">
                                        ...
                                        <select
                                            ...
                                            <option value="468x60"
                                                <?php if(isset($zones[0]->zonetype) && $zones[0]->width == '468' && $zones[0]->height == '60'){echo 'selected';} ?>>
                                                IAB Full Banner (468 x 60)</option>
                                            <option value="120x600"
                                                <?php if(isset($zones[0]->zonetype) && $zones[0]->width == '120' && $zones[0]->height == '600'){echo 'selected';} ?>>
                                                IAB Skyscraper (120 x 600)</option>
                                            <option value="728x90"
                                                <?php if(isset($zones[0]->zonetype) && $zones[0]->width == '728' && $zones[0]->height == '90'){echo 'selected';} ?>>
                                                IAB Leaderboard (728 x 90)</option>
                                            <option value="120x90"
                                                <?php if(isset($zones[0]->zonetype) && $zones[0]->width == '120' && $zones[0]->height == '90'){echo 'selected';} ?>>
                                                IAB Button 1 (120 x 90)</option>
                                            <option value="120x60"
                                                <?php if(isset($zones[0]->zonetype) && $zones[0]->width == '120' && $zones[0]->height == '60'){echo 'selected';} ?>>
                                                IAB Button 2 (120 x 60)</option>
                                            <option value="234x60"
                                                <?php if(isset($zones[0]->zonetype) && $zones[0]->width == '234' && $zones[0]->height == '60'){echo 'selected';} ?>>
                                                IAB Half Banner (234 x 60)</option>
                                            <option value="88x31"
                                                <?php if(isset($zones[0]->zonetype) && $zones[0]->width == '88' && $zones[0]->height == '31'){echo 'selected';} ?>>
                                                IAB Micro Bar (88 x 31)</option>
                                            <option value="125x125"
                                                <?php if(isset($zones[0]->zonetype) && $zones[0]->width == '125' && $zones[0]->height == '125'){echo 'selected';} ?>>
                                                IAB Square Button (125 x 125)</option>
                                            <option value="120x240"
                                                <?php if(isset($zones[0]->zonetype) && $zones[0]->width == '120' && $zones[0]->height == '240'){echo 'selected';} ?>>
                                                IAB Vertical Banner (120 x 240)</option>
                                            <option value="180x150"
                                                <?php if(isset($zones[0]->zonetype) && $zones[0]->width == '180' && $zones[0]->height == '150'){echo 'selected';} ?>>
                                                IAB Rectangle (180 x 150)</option>
                                            <option value="300x250"
                                                <?php if(isset($zones[0]->zonetype) && $zones[0]->width == '300' && $zones[0]->height == '250'){echo 'selected';} ?>>
                                                IAB Medium Rectangle (300 x 250)</option>
                                            <option value="336x280"
                                                <?php if(isset($zones[0]->zonetype) && $zones[0]->width == '336' && $zones[0]->height == '280'){echo 'selected';} ?>>
                                                IAB Large Rectangle (336 x 280)</option>
                                            <option value="240x400"
                                                <?php if(isset($zones[0]->zonetype) && $zones[0]->width == '240' && $zones[0]->height == '400'){echo 'selected';} ?>>
                                                IAB Vertical Rectangle (240 x 400)</option>
                                            <option value="250x250"
                                                <?php if(isset($zones[0]->zonetype) && $zones[0]->width == '250' && $zones[0]->height == '250'){echo 'selected';} ?>>
                                                IAB Square Pop-up (250 x 250)</option>
                                            <option value="160x600"
                                                <?php if(isset($zones[0]->zonetype) && $zones[0]->width == '160' && $zones[0]->height == '600'){echo 'selected';} ?>>
                                                IAB Wide Skyscraper (160 x 600)</option>
                                            <option value="720x300"
                                                <?php if(isset($zones[0]->zonetype) && $zones[0]->width == '720' && $zones[0]->height == '300'){echo 'selected';} ?>>
                                                IAB Pop-Under (720 x 300)</option>
                                            <option value="300x100"
                                                <?php if(isset($zones[0]->zonetype) && $zones[0]->width == '300' && $zones[0]->height == '100'){echo 'selected';} ?>>
                                                IAB 3:1 Rectangle (300 x 100)</option>
                                            <option value="-"
                                                <?php if(isset($zones[0]->zonetype) && $zones[0]->zonetype == 'custom'){echo 'selected';} ?>>
                                                Custom</option>
            ...
            <div class="errormessage" style="margin-top: 2em"><img class="errormessage"
                    ...
                    align="absmiddle">There are currently no sites available add it first</div>
