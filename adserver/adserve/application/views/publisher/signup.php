...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        <div class="register-box-body register-box-margin">
            <?php if(isset($msg)){ ?>
            ...
            <form action="<?php echo base_url();?>publisher/signup" method="post" accept-charset="utf-8"
                class="form-signin" id="vForm" class="form-signin" name="vform">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-3">
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" name="firstname" id="firstname" class="form-control" type="text"
                                id="email" class="form-control" name="email" data-validate
                    ...
                    <div class="col-md-6">
                        <div class="form-group has-feedback">
                            ...
                            <input type="password" name="password" id="password" class="form-control" data-validate
                                data-required="Please enter password"
                                data-compare="password_confirm;Password did not match" data-err-id="password_error" />
                    ...
                    <div class="col-md-6">
                        <div class="form-group has-feedback">
                            ...
                            <input type="password" name="cnfm-password" id="password_confirm" class="form-control"
                                ...
                                data-compare="password;Confirm password did not match"
                                data-err-id="confirm_password_error">
                            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group has-feedback">
                            ...
                            <font style="color:#900;">*</font>
                            <input type="text" name="company" id="companyname" class="form-control" type="text"
                                id="email" class="form-control" data-validate data-required="Please enter company Name"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <input type="submit" name="submit" value="Sign In" class="btn btn-large btn-primary btn-margin">
                    </div>
                </div>
            </form>
