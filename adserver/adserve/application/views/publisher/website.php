		...
		<div class="row" >
			<div class="col-md-12">
				<div class="box box-default">
					<?php if(isset($affiliates[0]->affiliateid)){$this->load->view('publisher/target_header');}?>
					...
					<form method="post"	name = "addwebsite" id = "addwebsite">
						<div class="box-body">
							...
							<div class="col-md-7">
								<div class="form-group">
									<label for="contact" class="fieldlabel">Phone<font style="color:#F44336;">*</font></label>
