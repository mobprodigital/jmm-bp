                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6 col-md-offset-3 login-box-body">
                                ...
                                <form action="<?php echo base_url();?>publisher/profile?uid=<?php echo $_GET['uid'];?>"
                                    method="post" accept-charset="utf-8" class="form-signin">
                                    <div class="col-md-10 col-md-offset-1">
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <input type="text" name="firstname"
                                                value="<?php echo $profile->firstname;?>" class="form-control">
                                        </div>
                                        <div class="form-group has-feedback">
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <input type="password" name="password"
                                                value="<?php echo $profile->password;?>" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="" style="right: 0;position: absolute;margin-top: 10px;color: #00a9e8;"> Change
                                                Password ?</a>
                                        </div>
                                    </div>
                                </form>
