            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <form action="<?php echo base_url()?>publisher/webzonestats" name="period_form" id="period_form"
                            autocomplete="off">
                            ...
                            <select tabindex="1" onchange="periodFormChange(1)" id="period_preset" name="period_preset">
                                <option value="today"
                                    <?php if(isset($period_preset) && $period_preset=='today'){echo 'selected';} ?>>
                                    Today</option>
                                <option value="yesterday"
                                    <?php if(isset($period_preset) && $period_preset=='yesterday'){echo 'selected';} ?>>
                                    Yesterday</option>
                                <option value="this_month"
                                    <?php if(isset($period_preset) && $period_preset=='this_month'){echo 'selected';} ?>>
                                    This month</option>
                                <option value="all_stats"
                                    <?php if(isset($period_preset) && $period_preset=='all_stats'){echo 'selected';} ?>>
                                    All statistics</option>
                                <option value="specific"
                                    <?php if(isset($period_preset) && $period_preset=='specific'){echo 'selected';} ?>>
                                    Specific dates</option>
                            </select>
                            <label style="margin-left: 1em" for="period_start"></label>
                            <input type="text" tabindex="0"
                                value="<?php if(isset($period_start)){echo $period_start;} ?>" id="period_start"
                                name="period_start" class="date" readonly=""
                                style="<?php if(isset($period_preset) && !($period_preset=='specific')){echo 'background-color: rgb(204, 204, 204)';}?>;" />
                            <input type="image" border="0" align="absmiddle" tabindex="0" id="period_start_button"
                                src="<?php echo base_url();?>assets/upimages/icon-calendar-d.gif" disabled=""
                                readonly="" style="cursor: default;">

                            <label style="margin-left: 1em" for="period_end"> </label>
                            <input type="text" tabindex="0" value="<?php if(isset($period_end)){echo $period_end;} ?>"
                                id="period_end" name="period_end" class="date" readonly=""
                                style="<?php if(isset($period_preset) && !($period_preset=='specific')){echo 'background-color: rgb(204, 204, 204)';}?>;" />
                            <input type="image" border="0" align="absmiddle" tabindex="0" id="period_end_button"
                                src="<?php echo base_url();?>assets/upimages/icon-calendar-d.gif" disabled=""
                                readonly="" style="cursor: default;">

                            <a onclick="return periodFormSubmit()" href="#">
                                <img border="0" tabindex="6"
                                    src="<?php echo base_url();?>assets/upimages/ltr/go_blue.gif"></a>

                        </form></br></br>
                        <a class="btn btn-default" accesskey="e" style="float:right;"
                            href="stats.php?statsBreakdown=day&amp;period_preset=today&amp;period_start=2016-04-18&amp;period_end=2016-04-18&amp;listorder=name&amp;orderdirection=up&amp;day=&amp;setPerPage=15&amp;entity=global&amp;breakdown=history&amp;plugin=advertiser:statshistory">
                            <img border="0" alt="" src="<?php echo base_url();?>assets/upimages/excel.gif">
                            <u>E</u>xport Statistics to Excel </a>
                        ...
                        <table id="example" style="margin-top: 10px;" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th width="52%">Name<img align="absmiddle" width="10" height="10"
                                            src="<?php echo base_url();?>assets/upimages/caret-u.gif"></th>
                                    <th width="12%">Impr.</th>
                            ...
                            <tbody>
                                ...
                                <tr
                                    style="outline: thin solid <?php if($key % 2 == 0){echo '#e6e6e6';}else{echo '#ffffff';}?>">
                                    <td><img align="absmiddle" width="16" height="16"
                                            src="<?php echo base_url();?>assets/upimages/ltr/triangle-l.gif">

                                        <?php if(isset($_GET['breakthrough']) && $_GET['breakthrough'] == 'zone'){ ?>
                                        <?php if (isset($_GET['zoneid'])){ ?>
                                        <img align="absmiddle" width="16" height="16"
                                            src="<?php echo base_url();?>assets/upimages/icon-date.gif">
                                        <a
                                            href="<?php echo base_url().'publisher/webzonestats?breakthrough=zone&affiliateid='.$_GET['affiliateid'].'&breakthrough=daily';?>"><?php echo $value->day;?></a>
                                        <?php }else{ ?>
                                        <img align="absmiddle" width="16" height="16"
                                            src="<?php echo base_url();?>assets/upimages/icon-zones.png"><a href="">
                                            <a
                                                href="<?php echo base_url().'publisher/webzonestats?breakthrough=zone&affiliateid='.$_GET['affiliateid'].'&zoneid='.$value->zoneID;?>"><?php echo $value->zoneName;?></a>
                                            <?php } ?>
                                            ...
                                            <img align="absmiddle" width="16" height="16"
                                                src="<?php echo base_url();?>assets/upimages/icon-date.gif"><a href="">
                                                <a
                                                    href="<?php echo base_url().'publisher/webzonestats?breakthrough=campaigns&affiliateid='.$_GET['affiliateid'].'&campaignid='.$value->campaignID;?>"><?php echo $value->day;?></a>
                                                <?php }else{ 
											...
											?>
                                                <img align="absmiddle" width="16" height="16"
                                                    src="<?php echo base_url();?>assets/upimages/icon-campaign.gif"><a
                                                    href="">
                                                    <a
                                                        href="<?php echo base_url().'publisher/webzonestats?breakthrough=campaigns&affiliateid='.$_GET['affiliateid'].'&campaignid='.$value->campaignID.$campaignZoneString;?>"><?php echo $value->campaignName;?></a>
                                                    ...
                                                    <a
                                                        href="<?php echo base_url().'publisher/webzonestats?breakthrough=day';?>"><?php echo $value->day;?></a>

                                                    <?php }else{ ?>
                                                    <img align="absmiddle" width="16" height="16"
                                                        src="<?php echo base_url();?>assets/upimages/icon-affiliate.gif"><a
                                                        href="">

                                                        <a
                                                            href="<?php echo base_url().'publisher/webzonestats?affiliateid='.$value->affiliateid;?>"><?php echo $value->name;?></a>
                                                        <?php } ?>
                                                        <?php } ?>
                                ...
                                <tr style="font-weight: 700;">
                                    ...
                                    <td class="aright last"><?php echo round((($totalClk / $totalImpr)*100),2).'%';?>
                                    </td>
                        ...
                        <div class="errormessage" style="margin-top: 2em"><img class="errormessage"
                                src="<?php echo base_url();?>assets/upimages/info.gif" width="16" height="16" border="0"
                                align="absmiddle">There are currently no statistics available for the given period</div>
                        <?php } ?>
...
function periodFormChange(bAutoSubmit) {
    ...
    document.getElementById('period_start_button').src = specific ?
        'http://localhost/revive/www/admin/assets/images/icon-calendar.gif' :
        'http://localhost/revive/www/admin/assets/images/icon-calendar-d.gif';
    document.getElementById('period_end_button').src = specific ?
        'http://localhost/revive/www/admin/assets/images/icon-calendar.gif' :
        'http://localhost/revive/www/admin/assets/images/icon-calendar-d.gif';
