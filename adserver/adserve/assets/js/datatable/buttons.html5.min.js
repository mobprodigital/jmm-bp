(function (i) {
    ...
    o.ext.buttons.excelHtml5 = {
        ...
        action: function (a, b, d, c) {
            ...
            exlName && (r([exlName], g), k(g, d.header.length - 1));
            p.messageTop && (r([p.messageTop],
                g), k(g, d.header.length - 1));
            c.header && (r(d.header, g), i("row:last c", e).attr("s", "20"));
            ...
            b.generateAsync ? b.generateAsync(d).then(function (a) {
                ...
                t(a, exlName);
                f.processing(false)
            }) : (t(b.generate(d), exlName), this.processing(!1))
        },
        filename: "*",
        extension: ".xlsx",
        exportOptions: {},
