...
function renderVastOutput(){
	...
	$vast['vast_thirdparty_erorr']		= $deliveryPath.'core/error/vast-error.php?bannerid='.$bannerid."&zoneid=".$zoneid."&event=none&cb=".$rand;;
	$vast['vast_thirdparty_impression']	= $deliveryPath.'core/lgimpr.php?bannerid='.$bannerid."&zoneid=".$zoneid."&event=impression&cb=".$rand;
	$vast['third_party_click']			= $deliveryPath.'core/ckvast.php?bannerid='.$bannerid."&zoneid=".$zoneid."&event=clicks&cb=".$rand;
	$vast['start_pixel']				= $deliveryPath.'core/lgvast.php?bannerid='.$bannerid."&zoneid=".$zoneid."&event=start";
	$vast['quater_pixel']				= $deliveryPath.'core/lgvast.php?bannerid='.$bannerid."&zoneid=".$zoneid."&event=firstquartile";
	$vast['mid_pixel']					= $deliveryPath.'core/lgvast.php?bannerid='.$bannerid."&zoneid=".$zoneid."&event=midpoint";
	$vast['third_quater']				= $deliveryPath.'core/lgvast.php?bannerid='.$bannerid."&zoneid=".$zoneid."&event=thirdquartile";
	$vast['end_pixel']					= $deliveryPath.'core/lgvast.php?bannerid='.$bannerid."&zoneid=".$zoneid."&event=complete";
	$vast['generalUrl']					= $deliveryPath.'core?bannerid='.$bannerid."&zoneid=".$zoneid."&event=none"; 	
	$vast['mute']						= $deliveryPath.'core?bannerid='.$bannerid."&zoneid=".$zoneid."&event=mute"; 	
	$vast['unmute']						= $deliveryPath.'core?bannerid='.$bannerid."&zoneid=".$zoneid."&event=unmute"; 	
	$vast['skip']						= $deliveryPath.'core/lgvast.php?bannerid='.$bannerid."&zoneid=".$zoneid."&event=skip"; 	
